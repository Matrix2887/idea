package cn.gandan.day09.demo07;
...
//1.创建Properties集合对象,添加数据
        Properties prop = new Properties();
        prop.setProperty("艾登.皮尔斯","38");
        prop.setProperty("富兰克林","28");
        prop.setProperty("麦克.迪圣塔","48");
//2.创建字节输出流/字符输出流对象,构造方法中绑定要输出的目的地
...
//        fw.close();
        ...
        prop.store(new FileOutputStream("day09-code\\prop.txt"),"");
    }
