...
public class Demo01TryCatch {
    public static void main(String[] args) {
        try {
            // 可能产生异常的代码
            readFile("D:\\\\a.tx");
//            System.out.println("释放");// 没执行
        }catch (IOException e){// try中抛出什么异常对象,catch就定义什么异常变量,用来接收这个异常对象

            // 异常的处理逻辑,产生异常对象之后,怎么处理异常对象
//            System.out.println("catch - 文件后缀名不是.txt");
...
//            System.out.println(e);// java.io.IOException: 文件后缀名错误
	        ...
	        at cn.gandan.day05.demo02.Demo01TryCatch.readFile(Demo01TryCatch.java:60)
	        at cn.gandan.day05.demo02.Demo01TryCatch.main(Demo01TryCatch.java:28)
             */
            e.printStackTrace();
        }
