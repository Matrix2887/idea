          ...
          <div class="form-group">
            <label for="address">籍贯：</label>
             <select name="address" id="address" class="form-control" >
                 <c:if test="${user.address == '仙女'}">
                     <option value="仙女"selected>仙女</option>
                     <option value="沙滩">沙滩</option>
                     <option value="海滩">海滩</option>
                 </c:if>
                 <c:if test="${user.address == '沙滩'}">
                     <option value="仙女">仙女</option>
                     <option value="沙滩"selected>沙滩</option>
                     <option value="海滩">海滩</option>
                 </c:if>
                 <c:if test="${user.address == '海滩'}">
                     <option value="仙女">仙女</option>
                     <option value="沙滩">沙滩</option>
                     <option value="海滩"selected>海滩</option>
                 </c:if>
